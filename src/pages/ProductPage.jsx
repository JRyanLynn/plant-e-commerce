...
const ProductPage = () => {
    //function allows for the use of zeros in decimals
    ...
    //need a product sorting function here to mix plant types here

    const [sort, setSort] = useState(false);

    const [array, setArray] = useState(productArray, false);

    const filterArray = () => {
        const filteredArray = array.filter(item => {return item.care.includes('easy')});
    ...
    <Page>
        ...
        <PageContainer>
            ...
            <List>
                ...
                <ListItem key = {array.light} onClick = {() => filterArray()}><ListInput type = 'checkbox'  />Easy</ListItem>
            ...
            <List>
                ...
                <ListItem><ListInput type = 'checkbox' />Flower</ListItem>
                <ListItem><ListInput type = 'checkbox' />Leafy Plants</ListItem>
                <ListItem><ListInput type = 'checkbox' />Edible</ListItem>
                <ListItem><ListInput type = 'checkbox' />Herb</ListItem>
            </List>
            ...
            <ProductGridWrapper>
               ...
               {array.map((item, index)=> (<ProductCard key = {item.id}>
                    ...
                    <ProductInfo key = {item.id}>
                        ...
                        <ProductPrice key = {item.price}>{item.price}</ProductPrice>
                    </ProductInfo>
                    </ProductCard>
                    ))}
